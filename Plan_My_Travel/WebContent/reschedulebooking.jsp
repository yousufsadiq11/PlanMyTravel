...
<div class="panel">
  ...
  <form method="post" action=registerusersearch.jsp>
 <p><input type="radio" name="test" value="<%=f.getFlight_id() %>" >Reschedule booking</p>
 <input type="hidden" name="bookingid" value="<%=f.getbooking_id() %>">
 <%String s= (String)request.getAttribute("session");%>
 <%=s %>
 <% session.setAttribute("s",s);%>
 <% request.setAttribute("reschedulebooking",f);%>
<input type="submit">
</form>
</div>
